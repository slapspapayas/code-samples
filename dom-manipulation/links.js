/*
 * This script will find all CMS generated links and
 * if they are to sections of current page add smooth-scroll
 */
(function() {
    window.addEventListener('DOMContentLoaded', function() {
        ...
        if (!!content) {
            ...
            // Replaced live DOM content with fragment
            ...
            if (hash) {
                ...
                if (smoothScroll && el) {
                    ...
                    smoothScroll.animateScroll(el, hash, {
                        offset: offset
                    });
                }
            }
